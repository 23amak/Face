...
def get_dataloader(batch_size, image_size, data_dir='C:/Users/foggy/Documents/img_align_celeba'):
    """
...
class Generator(nn.Module):
    ...
    def __init__(self, z_size, conv_dim):
        ...
        super(Generator, self).__init__()
        self.conv_dim = conv_dim
        self.fc = nn.Linear(z_size,conv_dim*14*2*2)
    ...
    def forward(self, x):
        ...
        # define feedforward behavior
        x = self.fc(x)
        x = x.view(-1,self.conv_dim*14,2,2) #(batch_size,depth,width,height)
